...
(() => {
  ...
  function updateTarget(){
    ...
    const priceText=daily>0?new Intl.NumberFormat('en-US',{style:'currency',currency:'USD',minimumFractionDigits:2,maximumFractionDigits:2}).format(required):'—';
...
(() => {
  ...
  function usd(value,digits=2){
    return new Intl.NumberFormat('en-US',{style:'currency',currency:'USD',minimumFractionDigits:digits,maximumFractionDigits:digits}).format(num(value));
  }
  ...
  function updateLive(){
    ...
    if(typeof rollValue === 'function'){
      ...
      rollValue('landscapeWalletInj',`${inj(total,4)} INJ`,total);
      ...
      put('landscapeWalletInj',`${inj(total,4)} INJ`);
      put('landscapeWalletAvailable',inj(available,4));
      put('landscapeWalletStaked',inj(staked,4));
