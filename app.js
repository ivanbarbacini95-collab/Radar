  ...
  try{
    ...
    Promise.resolve().then(async()=>{
      ...
      if(market?.market_cap){
        ...
        sthourge.setJSON('inj_market_metadata_v836',{marketCap:state.marketCap,marketRank:state.marketRank,circulatingSupply:state.circulatingSupply,source,time:Date.now()});
      }else{
        const cached=sthourge.getJSON('inj_market_metadata_v836',{});
